...
const YourTableComponent = ({ data }) => {
  ...
  const fetchData = async () => {
    ...
    if (newData.leaderBoard.length > 0) {
      ...
      const combinedData = [...tableData, ...newData.leaderBoard];

      // Sort the combined data by lap time in ascending order
      combinedData.sort((a, b) => a.lap.lapTimeInMS - b.lap.lapTimeInMS);
